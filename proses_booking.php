    ...
    <div style="max-width: 600px; margin: auto; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
      ...
      <div style="padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr><td style="padding: 8px;">📅 <strong>Kode Booking:</strong></td><td>' .
        htmlspecialchars($kode_booking) .
        '</td></tr>
          <tr><td style="padding: 8px;">📅 <strong>Tanggal:</strong></td><td>' .
        htmlspecialchars($tanggal_booking) .
        '</td></tr>
          <tr><td style="padding: 8px;">⏰ <strong>Jam:</strong></td><td>' .
        htmlspecialchars($jam_booking) .
        '</td></tr>
          <tr><td style="padding: 8px;">🔧 <strong>Layanan:</strong></td><td>' .
        htmlspecialchars($layanan) .
        '</td></tr>
          <tr><td style="padding: 8px;">🚗 <strong>Tipe Motor:</strong></td><td>' .
        htmlspecialchars($tipe_motor) .
        '</td></tr>
          <tr><td style="padding: 8px;">📞 <strong>No HP:</strong></td><td>' .
        htmlspecialchars($no_hp) .
        '</td></tr>
          <tr><td style="padding: 8px;">📝 <strong>Keluhan:</strong></td><td>' .
      ...
      <div style="background-color: #f1f1f1; padding: 15px; text-align: center; font-size: 12px; color: #666;">
        &copy; ' .
        date("Y") .
        ' Servis Motor. All rights reserved.
      </div>
    </div>
  </div>
        ';
