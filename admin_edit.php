...
<div class="container mt-5">
  ...
  <form method="POST" class="border border-dark p-4 bg-white shadow rounded d-grid gap-2">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" name="nama" value="<?= $data[
          "nama"
      ] ?>" required>
    </div>
    <div class="mb-3">
      <label class="form-label">No HP</label>
      <input type="text" class="form-control" name="no_hp" value="<?= $data[
          "no_hp"
      ] ?>" required>
    </div>
    <div class="mb-3">
      <label class="form-label">Tipe Motor</label>
      <input type="text" class="form-control" name="tipe_motor" value="<?= $data[
          "tipe_motor"
      ] ?>">
    </div>
    <div class="mb-3">
      ...
      <select class="form-select" name="layanan">
        <option <?= $data["layanan"] == "Ganti Oli"
            ? "selected"
            : "" ?>>Ganti Oli</option>
        <option <?= $data["layanan"] == "Servis Ringan"
            ? "selected"
            : "" ?>>Servis Ringan</option>
        <option <?= $data["layanan"] == "Servis Berat"
            ? "selected"
            : "" ?>>Servis Berat</option>
        <option <?= $data["layanan"] == "Tambal Ban"
            ? "selected"
            : "" ?>>Tambal Ban</option>
      </select>
    </div>
    <div class="mb-3">
      ...
      <textarea class="form-control" name="keluhan"><?= $data[
          "keluhan"
      ] ?></textarea>
    </div>
    <div class="mb-3">
      <label class="form-label">Tanggal Booking</label>
      <input type="date" class="form-control" name="tanggal_booking" value="<?= $data[
          "tanggal_booking"
      ] ?>" required>
    </div>
    <div class="mb-3">
      <label class="form-label">Jam Booking</label>
      <input type="time" class="form-control" name="jam_booking" value="<?= $data[
          "jam_booking"
      ] ?>" required>
    </div>
    <div class="mb-3">
      <label for="status" class="form-label">Status</label>
        <select name="status" class="form-select" required>
          <option value="Menunggu" <?= $data["status"] == "Menunggu"
              ? "selected"
              : "" ?>>Menunggu</option>
          <option value="Diproses" <?= $data["status"] == "Diproses"
              ? "selected"
              : "" ?>>Diproses</option>
          <option value="Selesai" <?= $data["status"] == "Selesai"
              ? "selected"
              : "" ?>>Selesai</option>
        </select>
    </div>
